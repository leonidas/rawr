(function() {
  ...
  Chart = (function() {
    ...
    function Chart(where, width, height, margin, styles) {
      ...
      this.trackAllTimeSeriesNames = __bind(this.trackAllTimeSeriesNames, this);
      this.hierarchizeData = __bind(this.hierarchizeData, this);
      this.drawPage = __bind(this.drawPage, this);
    ...
    Chart.prototype.setData = function(data) {
      this.data = this.hierarchizeData(data);
      this.pageNames = _.keys(this.data);
      this.allTimeSeriesNames = this.trackAllTimeSeriesNames(this.allTimeSeriesNames, this.data);
      this.currentPageNumber = 0;
      this.calculateScale(this.data);
      this.drawXLabels();
      this.drawYLabels();
      return this.drawPage(this.pageNames[this.currentPageNumber]);
    };

    Chart.prototype.drawPage = function(pageName) {
      var _this = this;
      return _.each(this.allTimeSeriesNames, function(seriesName) {
        var _ref;
        return _this.updateDataLayer(seriesName, (_ref = _this.data[pageName][seriesName]) != null ? _ref : []);
      });
    };

    Chart.prototype.hierarchizeData = function(data) {
    ...
    Chart.prototype.trackAllTimeSeriesNames = function(allTimeSeriesNames, data) {
    ...
    Chart.prototype.updateDataLayer = function(layerName, data) {
