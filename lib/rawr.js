(function() {
  ...
  Chart = (function() {
    ...
    Chart.prototype.draw = function(array_data, styles) {
      var map_data,
        _this = this;
      map_data = {
        "main": array_data[0],
        "overlay": array_data[1]
      };
      this.calculateScale(map_data);
      this.drawXLabels();
      this.drawYLabels();
      return _.each(map_data, function(layer, layerName) {
        return _this.updateDataLayer(layer, styles, layerName);
      });
    };
