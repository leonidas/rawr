(function() {
  ...
  Chart = (function() {
    ...
    Chart.prototype.calculateScale = function(data) {
      ...
      this.oldYScale = (_ref = this.yScale) != null ? _ref : 0;
    ...
    Chart.prototype.drawYLabels = function() {
      ...
      return this.yLabels.exit().transition().duration(500).attr("y", this.yScale).text(String).style("opacity", "0").remove();
    };
