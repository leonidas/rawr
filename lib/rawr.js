(function() {
  ...
  Chart = (function() {
    ...
    Chart.prototype.setData = function(data, styles) {
      this.styles = styles;
    ...
    Chart.prototype.drawPage = function(pageName) {
      var _this = this;
      return _.each(this.data[pageName], function(seriesData, seriesName) {
        return _this.updateDataLayer(seriesName, seriesData);
      });
    };
